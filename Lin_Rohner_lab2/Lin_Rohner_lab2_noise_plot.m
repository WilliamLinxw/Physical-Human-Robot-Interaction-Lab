...
[t, s] = title('Signal with noise of the Hall-Sensor in [V] and [deg]', ['Mean = ' num2str(mean_position_volt) ' volts ---> ' num2str(mean_position_deg) ' degrees' newline 'Standard deviation = ' num2str(std_position_volt) ' volts ---> ' num2str(std_position_deg) ' degrees']);
t.FontSize = 16;
s.Color = 'red';
s.FontAngle = 'italic';
