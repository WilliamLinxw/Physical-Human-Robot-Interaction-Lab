...
% Plot fit with data.
figure( 'Name', 'Transparency Planes','NumberTitle','off' );
sgtitle('Transparency Planes', 'fontsize', 20);
subplot(1,3,1);
p_fit_uc = plot(fit_uc, [acceleration_uc, velocity_uc], torque_uc);
title('Uncontrolled', FontSize=18)
legend( p_fit_uc, 'Fit Transparency Planes', 'Torque vs. Acceleration, Velocity', 'Location', 'NorthEast', 'Interpreter', 'none', 'fontsize',12 );
% Label axes
xlabel( 'Acceleration [rad/s^2]', 'Interpreter', 'none', FontSize=12 );
ylabel( 'Velocity [rad/s]', 'Interpreter', 'none', FontSize=12 );
zlabel( 'Torque [Nm]', 'Interpreter', 'none', FontSize=12 );
grid on

subplot(1,3,2);
p_fit_fg = plot( fit_fg, [acceleration_fg, velocity_fg], torque_fg);
title('Friction and Gravity Compensated', FontSize=18)
% Label axes
xlabel( 'Acceleration [rad/s^2]', 'Interpreter', 'none', FontSize=12 );
ylabel( 'Velocity [rad/s]', 'Interpreter', 'none', FontSize=12 );
zlabel( 'Torque [Nm]', 'Interpreter', 'none' , FontSize=12);
...
title('Force Feedback', FontSize=18)
subtitle('(Feedback Gain: KF = 1.15)', FontSize=12);
% Label axes
xlabel( 'Acceleration [rad/s^2]', 'Interpreter', 'none', FontSize=12 );
ylabel( 'Velocity [rad/s]', 'Interpreter', 'none', FontSize=12 );
zlabel( 'Torque [Nm]', 'Interpreter', 'none', FontSize=12 );
